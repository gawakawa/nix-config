---
name: review-loop
description: "One disciplined pass of /code-review -> triage -> fix on the current branch; pair with /goal to repeat until clean or a turn cap. Optional arg: code-review effort (low|medium|high|max, default high). Triggers on phrases like 'review until clean', '指摘がなくなるまでレビューして'."
user-invocable: true
